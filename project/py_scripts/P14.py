...
More examples: https://github.com/CoreElectronics/CE-PiicoDev-SSD1306-MicroPython-Module
"""
...
for x in range(128):
    t = int(math.cos(x/10.0)*HEIGHT+HEIGHT+30)
    display.fill(0)
    display.text("Plots", 50, 10, 1)
    display.updateGraph2D(graphCos,t)
    display.show()
sleep_ms(1000)
